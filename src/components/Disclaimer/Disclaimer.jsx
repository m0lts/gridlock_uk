...
export const Disclaimer = () => {
    return (
        <section className='disclaimer'>
            ...
            <p>The App is for entertainment purposes only. We do not condone or promote gambling. We do not accept any responsibility for any financial loss or any other legal consequences that may arise from the use of this website. Please play responsibly.</p>
